...
@app.get("/")
async def root():
    return {"message": "To use this API to pridict a credit score make a post request to /predict with a body format of {Recency_WoE: float,Frequency_WoE: float,Monetary_WoE: float,Stability_WoE: float}"}
